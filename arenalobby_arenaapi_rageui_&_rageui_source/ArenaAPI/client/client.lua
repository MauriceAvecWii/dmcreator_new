...
RegisterNetEvent("dmcreator:loadMapData")
AddEventHandler("dmcreator:loadMapData", function(mapData)
    -- Logik, um die Karte auf dem Client zu laden
    print("Map geladen: ", json.encode(mapData))
    -- Platzieren von Objekten, Spawnpoints usw.
end)
